...
class Item:
    ...
    def __str__(self):
        """
        Магический метод __str__, возвращает строку (для пользователя(например через print()))
        """
        return self.__name
    ...
    def __add__(self, other):
        ...
        raise TypeError('Не является экземпляром класса Item или его дочерним классом Phone')
